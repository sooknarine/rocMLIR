...
#transform_map25 = #rock.transform_map<#map21 by [<PassThrough ["g_block", "m_block", "n_block"] at [0, 1, 2] -> ["g_block", "m_block", "n_block"] at [0, 1, 2]>, <Merge{4, 2, 32} ["tid"] at [3] -> ["1ave", "m_tid", "n_tid"] at [3, 4, 5]>, <Merge{1, 1, 4, 4} ["item"] at [4] -> ["i", "j", "vec_group", "vec_item"] at [6, 7, 8, 9]>] bounds = [1, 6, 16, 256, 16] -> [1, 6, 16, 4, 2, 32, 1, 1, 4, 4]>
#transform_map26 = #rock.transform_map<#map22 by [<PassThrough ["g_block", "m_block", "n_block"] at [0, 1, 2] -> ["g_block", "m_block", "n_block"] at [0, 1, 2]>, <Merge{2, 2} ["1ave"] at [3] -> ["1ave_m", "1ave_n"] at [3, 4]>, <PassThrough ["m_tid", "n_tid"] at [4, 5] -> ["m_tid", "n_tid"] at [5, 6]>, <Merge{1, 1} ["i"] at [6] -> ["m_i", "n_i"] at [7, 8]>, <Merge{1, 1} ["j"] at [7] -> ["blk_row", "blk_col"] at [9, 10]>, <PassThrough ["vec_group", "vec_item"] at [8, 9] -> ["vec_group", "vec_item"] at [11, 12]>] bounds = [1, 6, 16, 4, 2, 32, 1, 1, 4, 4] -> [1, 6, 16, 2, 2, 2, 32, 1, 1, 1, 1, 4, 4]>
#transform_map27 = #rock.transform_map<#map23 by [<PassThrough ["g_block"] at [0] -> ["gemmG"] at [0]>, <Unmerge{6, 1, 2, 1, 4, 2, 4} ["m_block", "m_i", "1ave_m", "blk_row", "vec_group", "m_tid", "vec_item"] at [1, 7, 3, 9, 11, 5, 12] -> ["gemmM"] at [1]>, <Unmerge{16, 1, 2, 1, 32} ["n_block", "n_i", "1ave_n", "blk_col", "n_tid"] at [2, 8, 4, 10, 6] -> ["gemmN"] at [2]>] bounds = [1, 6, 16, 2, 2, 2, 32, 1, 1, 1, 1, 4, 4] -> [1, 384, 1024]>
...
module attributes {mhal.arch = "##TOKEN_ARCH##"} {
  func.func @rock_gemm(%arg0: memref<1x384x1024xf16>, %arg1: memref<1x1024x1024xf16>, %arg2: memref<1x384x1024xf16>) attributes {block_size = 256 : i32, grid_size = 96 : i32, kernel, mhal.arch = "##TOKEN_ARCH##", wave_size = 64 : i32} {
    ...
    %47 = rock.alloc() : memref<4xvector<8xf16>, #gpu.address_space<private>>
    %48 = rock.alloc() : memref<4xvector<8xf16>, #gpu.address_space<private>>
    ...
    affine.for %arg3 = 0 to 16 {
      ...
      rock.lds_barrier
      rock.blockwise_gemm_accel %49 += %47 from %view_4 * %48 from %view_6 features = ##TOKEN_FEATURES## {arch = "##TOKEN_ARCH##", blockSize = 256 : i32, inMPerThread = 2 : i32, inNPerThread = 2 : i32, params = #xldops_gemm_params, rotateMWithK, loadAfromLDS, loadBfromLDS} : memref<1xvector<16xf32>, #gpu.address_space<private>> += memref<4xvector<8xf16>, #gpu.address_space<private>> from memref<512xvector<8xf16>, #gpu.address_space<workgroup>> * memref<4xvector<8xf16>, #gpu.address_space<private>> from memref<512xvector<8xf16>, #gpu.address_space<workgroup>>
      rock.lds_barrier
    }
